  ...
  return (
    <main className="relative min-h-screen">
      ...
      <nav className="flex justify-between items-center p-6">
        ...
        <button className="text-highlight hover:text-white transition-colors">
      ...
      {/* Hero Content */}
      <div className="flex flex-col items-center justify-center text-center text-white mt-32">
      ...
      <div className="absolute bottom-8 left-6 flex gap-4">
        <Link href="#" className="text-highlight hover:text-white transition-colors">
